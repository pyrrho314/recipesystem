...
try:
    ...
    print "couldn't import astrodata"
    raise
...
parser.add_option("-p", "--port", dest = "port", default = 8888, type = "int",
       help="this is the port it will provide the ADKTOOL GUI on (http://localhost:<port>)"
       )
...
class RCat():
                ...
                def add(self, nd):
                    ...
                    #print "pt66", category
                    #print "pt67:", pprint.pformat(self.cat,4,80)
                    #raw_input()
                    #sys.exit()
    ...
    class IfaceHandler(BaseHTTPServer.BaseHTTPRequestHandler):
        ...
        def do_GET(s):
            ...
            if "showprims" in urlparms:
                from astrodata.RecipeManager import centralPrimitivesIndex
            ...
            if command == "" or command.isdigit():
                ...
                from astrodata.datatypes import get_classification_library
...
#                s.wfile.write('<div id="pk_content" style="padding:2px;margin:2px;float:left;border:solid black 1px"></div>')
                ...
                from astrodata.Descriptors import centralCalculatorIndex, calculatorPackageMap
                import astrodata.adinspect as adi
                print "538:"
                s.send_response(200)
                s.send_header("Content-type", "application/json")
                s.end_headers()
                ...
                import astrodata.adinspect as adi
                from astrodata.RecipeManager import centralPrimitivesIndex as cpi
